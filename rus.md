# Приём «машинка с клоунами» <a href="#note-1" id="ref-1" class="reference">*</a>: решение для адаптации изображений в отзывчивом веб-дизайне
...
<a href="#ref-1" id="note-1" class="note">*</a> Машинка с клоунами *(англ. Clown car)* – это распространенный в США комический трюк, при котором из крохотной машинки выбирается немыслимое количество клоунов. Часто применяется в комедийной мультипликации и кино, просмотреть пример можно [здесь][26]. *(примечание переводчика)*
