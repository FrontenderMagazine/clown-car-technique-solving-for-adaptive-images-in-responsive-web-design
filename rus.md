...
Из всего что нам доступно на сегодняшний день, приём «машинка с клоунами» 
...
Чудеса начинаются когда мы добавляем SVG в гибкий макет. Когда в первый раз 
...
<a href="#ref-*" id="note-*" class="note">*</a> Машинка с клоунами *(англ. 
